Anatomical Automatic Labeling (AAL) For SPM2
Version vbeta1
Date 13/01/2004
...
Neurofonctional Imaging Group (GIN, UMR6095, CYCERON, Caen ,France), which is 
...
An interface with the Statistical Parametric Mapping (SPM2) package (Friston et 
...
than the spm distribution (/usr/local/soft/spm2/toolbox)

unix> cp aal_for_spm2_vbeta1.tar.Z /usr/local/soft/spm2/toolbox
unix> cd /usr/local/soft/spm2/toolbox

IV.2 Expand the archive will create an anat_aal_vb1 directory
unix> uncompress aal_for_spm2_vbeta1.tar.Z
unix> tar xvf aal_for_spm2_vbeta1.tar

IV.3 Add this directory to your  matlab path
unix > setenv MATLABPATH ${MATLABPATH}:/usr/local/soft/spm2/toolbox/aal

V How to use the software.

V.0 IMPORTANT : AAL for SPM2 manages the orientation (neurological or radiological) of your images

V.1 Do a regular statistical analysis using spm2
...
In /usr/local/soft/spm2/toolbox/aal
The file ROI_MNI_V4.img
